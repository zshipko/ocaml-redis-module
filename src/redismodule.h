...
RedisModuleDict *
    REDISMODULE_API_FUNC(RedisModule_CreateDict)(RedisModuleCtx *ctx);
...
void
    REDISMODULE_API_FUNC(RedisModule_DictIteratorStop)(RedisModuleDictIter *di);
...
int REDISMODULE_API_FUNC(RedisModule_GetClusterNodeInfo)(RedisModuleCtx *ctx,
                                                         ...
                                                         int *port, int *flags);
char **
    REDISMODULE_API_FUNC(RedisModule_GetClusterNodesList)(RedisModuleCtx *ctx,
                                                          size_t *numnodes);
